# Graph Report - next-commerce-temp  (2026-06-20)

## Corpus Check
- 155 files · ~112,119 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 448 nodes · 557 edges · 21 communities detected
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 33 edges (avg confidence: 0.78)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6a94f491`
...
Cohesion: 0.06
Nodes (14): AccountTabs(), AddressForm(), LogoutButton(), CartSync(), CheckoutPage(), useAuth(), useCartSync(), Footer() (+6 more)

### Community 1 - "Community 1"
Cohesion: 0.08
Nodes (20): FadeInSection(), WhyCyraSection(), getCategories(), getCategoryBySlug(), checkInventory(), createOrder(), getOrderByNumber(), getOrders() (+12 more)

### Community 2 - "Community 2"
Cohesion: 0.08
Nodes (7): getStrapiMedia(), cn(), ProductConditionBadge(), calcDiscount(), ProductDiscountBadge(), ProductImage(), Badge()
...
Cohesion: 0.09
Nodes (8): SearchBar(), DropdownMenu(), DropdownMenuTrigger(), Sheet(), SheetDescription(), SheetTitle(), SheetTrigger(), sortAddressesByDefault()
...
Cohesion: 0.09
Nodes (9): AddressCard(), handleSubmit(), handleSubmit(), createAddress(), updateAddress(), useAddresses(), ReviewForm(), StarRatingInput() (+1 more)
...
Cohesion: 0.24
Nodes (6): RadioGroup(), RadioGroupItem(), Tabs(), TabsContent(), TabsList(), TabsTrigger()
...
- **Why does `cn()` connect `Community 2` to `Community 0`, `Community 4`, `Community 5`, `Community 7`, `Community 9`, `Community 10`, `Community 11`, `Community 12`, `Community 13`, `Community 14`, `Community 15`, `Community 16`, `Community 17`?**
  _High betweenness centrality (0.231) - this node is a cross-community bridge._
- **Why does `formatPrice()` connect `Community 4` to `Community 0`, `Community 2`, `Community 11`, `Community 5`?**
  _High betweenness centrality (0.131) - this node is a cross-community bridge._
- **Why does `strapiFetch()` connect `Community 1` to `Community 8`, `Community 4`?**
